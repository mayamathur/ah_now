...
navbarPage( "AHNow statistics", id = "navbar",
            ...
            tabPanel( "Basics",
                      sidebarPanel(
                        ...
                        selectInput( "type",
                                     label = "Event type",
                                     choices = types,
                                     selected = "HelperDetail_Displayed"),
            ...
            tabPanel( "Helper Detail Displayed",
                      sidebarPanel(
                        ...
                        checkboxGroupInput("plotPlatforms3", "Platforms to show in plot:",
                                           c("iPhone" = "iPhone",
                                             "Android" = "android",
                                             "Mobile web" = "mweb",
                                             "Regular website" = "web"),
                      ...
                      mainPanel(
                        h3("Map of Individual Helper's Record"),
                        HTML( paste('Hover over a point for more information.') ),
                        withSpinner( plotlyOutput("helperDetail_Displayed_Map", width="750px", height="500px") ),                        # textOutput("txt"),
                        h3("Individual Helper's Record"),
                        withSpinner( DT::dataTableOutput(outputId = "HelperDetail_Displayed"))
                      )
            ), #end tabPanel
